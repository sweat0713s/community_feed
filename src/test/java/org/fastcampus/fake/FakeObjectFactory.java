...
public class FakeObjectFactory {
    ...
    private static final CommentRepository fakeCommenRepository = new FakeCommentRepository();
    ...
    private static final CommentService commonService = new CommentService(userService, postService, fakeCommenRepository, fakeLikeRepository);
    ...
    public static CommentService getCommonService() {
